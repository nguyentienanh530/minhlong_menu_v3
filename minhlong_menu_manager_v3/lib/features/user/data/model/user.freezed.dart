...
class _$UserImpl implements _User {
  _$UserImpl(
      ...
      @JsonKey(name: 'data') final List<UserModel> users = const <UserModel>[]})
      : _users = users;
  ...
  @override
  String toString() {
    return 'User(paginationModel: $paginationModel, users: $users)';
  }
...
abstract class _User implements User {
  factory _User(
      ...
      @JsonKey(name: 'data') final List<UserModel> users}) = _$UserImpl;
